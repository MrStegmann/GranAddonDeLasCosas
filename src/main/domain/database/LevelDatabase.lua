--- Level Database
--- Transpiled from specs/003-Metadata/level-type.ts
local LevelDatabase = {}

LevelDatabase.levelTable = {
    noob = {
    ...
    boss = {
        ...
        [10] = { maxHealth = 368, expToLevel = -1, attPoints = 20, skillPoints = 20, heroicPoints = 8, maxPositiveTraits = 5 },
    },
}

_G.GAC_LevelDatabase = LevelDatabase
