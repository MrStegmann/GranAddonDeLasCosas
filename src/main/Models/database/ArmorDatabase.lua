...
ArmorDatabase.ArmorList = {
    ...
    mail = {
        ...
        requirements = {
            { slot = "chest", talents = { { talentId = "brutality", value = 1 } } },
            { slot = "legs", talents = { { talentId = "brutality", value = 1 } } }
        },
        penalties = {
            {
                slot = "chest",
            ...
            {
                slot = "hands",
                talents = { { talentId = "sleightOfHand", value = -1 } },
                movementPenalty = 0
            },
            {
                slot = "legs",
    ...
    plate = {
        ...
        requirements = {
            { slot = "chest", talents = { { talentId = "brutality", value = 2 } } },
            { slot = "legs", talents = { { talentId = "brutality", value = 2 } } },
            { slot = "head", talents = { { talentId = "brutality", value = 1 } } },
            { slot = "hands", talents = { { talentId = "brutality", value = 1 } } }
        },
        penalties = {
            {
                slot = "head",
...
ArmorDatabase.ArmorReinforcement = {
    leather = {
    ...
    mail = {
        ...
        magicalReduction = 0,
        durability = 2,
        penalties = { { talentId = "agileDefense", value = 1 } },
        movementPenalty = 0
    },
    plate = {
        ...
        magicalReduction = 0,
        durability = 3,
        requirements = { { talentId = "brutality", value = 1 } },
        penalties = { { talentId = "agileDefense", value = 2 } },
        movementPenalty = 1
    }
}
