...
addon.levelsTable = {
    ...
    ["normal"] = {
        ...
        [4] = { maxHealth = 41, expToLevel = 102 },
        [5] = { maxHealth = 49, expToLevel = 153 },
        [6] = { maxHealth = 57, expToLevel = 230 },
        [7] = { maxHealth = 65, expToLevel = 345 },
        [8] = { maxHealth = 74, expToLevel = 518 },
    ...
    ["elite"] = {
        ...
        [4] = { maxHealth = 82, expToLevel = 5904 },
        [5] = { maxHealth = 98, expToLevel = 6495 },
        [6] = { maxHealth = 114, expToLevel = 7145 },
        [7] = { maxHealth = 130, expToLevel = 7858 },
        [8] = { maxHealth = 148, expToLevel = 8646 },
    ...
    ["boss"] = {
        ...
        [4] = { maxHealth = 164, expToLevel = 15318 },
        [5] = { maxHealth = 196, expToLevel = 16850 },
        [6] = { maxHealth = 228, expToLevel = 18535 },
        [7] = { maxHealth = 260, expToLevel = 20389 },
        [8] = { maxHealth = 296, expToLevel = 22428 },
        [9] = { maxHealth = 332, expToLevel = 24671 },
        [10] = { maxHealth = 368, expToLevel = nil },
    },
}
