...
- [x] **Phase 1: File & Directory Migrations**
  ...
  - [/] Task 1.2: Move `src/Data/sistema_de_rol` into `src/main/Models/Data/`
  - [/] Task 1.3: Move `src/main/domain/` contents into `src/main/Models/`
  - [/] Task 1.4: Move `src/main/ports/` contents into `src/main/API/`
  - [/] Task 1.5: Move `src/main/adapters/events` and `network` into `src/main/Controllers/`
  - [/] Task 1.6: Evaluate and migrate remaining `src/main/adapters/` (cache, services, locales) to appropriate MVC folders.
  - [ ] Task 1.7: Delete old `adapters/`, `domain/`, `ports/`, and `src/Data/` directories.
